  ...
  return (
    ...
    <View style={styles.form}> 
       ...
       <TouchableOpacity style={styles.buttonRegisterText}>
             <Text style={styles.buttonRegisterText} onPress={()=> navigation.navigate('Homepage')}>Login</Text>
             
       </TouchableOpacity>
       <View style = {{textAlign: "center",fontWeight: "bold",marginTop: 10,color: "#fff"}}>
       <Text style = {{color : "#fff",fontWeight: "bold"}}>Or</Text></View>
       <TouchableOpacity style={styles.buttonRegisterText}>
            <Text style={styles.buttonRegisterText} onPress={()=> navigation.navigate('register')}>Register</Text>
       </TouchableOpacity>
